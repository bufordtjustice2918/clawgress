...
checks = [
    ...
    ("MVPv2.1-1", "Proxy backend enforcement (haproxy only)", cmd_pass("backend\":\"nginx\"") and cmd_pass("\"success\": false") and cmd_pass("policy.proxy.backend") and cmd_pass("set service clawgress policy proxy backend haproxy")),
