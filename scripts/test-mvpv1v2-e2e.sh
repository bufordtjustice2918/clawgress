...
checks = [
    ...
    ("MVPv2-1", "Proxy/SNI allowlist mode", cmd_pass("policy proxy mode sni-allowlist") and cmd_pass("policy proxy domain api.openai.com")),
    ...
    ("MVPv2-3", "Agent telemetry (usage/denies/cache)", cmd_pass("show clawgress telemetry") and log_has("PASS: API clawgress/telemetry returned success=true")),
